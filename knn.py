...
class KNN:
    ...
    def get_k_neighbors(self, point):
        ...
        for p in range(len(self.points)):
            k_nearest.append(self.distance_function(self.points[p], point))
        k_nearest = np.argsort(k_nearest)
    ...
    def predict(self, features):
        ...
        data point. This function needs to return a list of predicted labels for all test data points. :param
        features: List[List[float]] :return: List[int]
        """
        predictions = []
